      ...
      <main className="landing-main">
        <section className="hero-section">
          <div className="hero-content">
            ...
            {/* ── RiddimSync Windows Download ── */}
            <div className="riddimSync-download-row">
              <a
                href={exeDownloadUrl || '#'}
                target="_blank"
                rel="noreferrer"
                className="btn btn-riddimSync"
                download="RiddimSync-Setup.exe"
                onClick={(e) => {
                  if (!exeDownloadUrl) {
                    e.preventDefault();
              ...
              >
                <Download size={18} />
                <span className="riddimSync-btn-label">
                  <span className="riddimSync-btn-name">RiddimSync</span>
                  <span className="riddimSync-btn-sub">Windows Download · v{APP_VERSION}</span>
                </span>
              </a>
            </div>
